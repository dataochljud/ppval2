...
$l = $lan;
?><div id="lokalmeny">
<p><a href="fget_lokaler.php?kommun=<?php echo $kommun; ?>&lan=<?php echo $lan; ?>">[Visa alla lokaler]</a><a href="fget_lokaler.php?kommun=<?php echo $kommun ?>&lan=<?php echo $lan; ?>">[Visa endast vallokaler]</a></p>
</div>
<?php
//echo $kommun . ' ' . $lan . '<br>';
$sql = 'SELECT * FROM vallokal where KommunKod=' .  htmlspecialchars($kommun) . ' AND LanKod=' .  htmlspecialchars($lan) . ' and typ="F"';
//echo $sql . '<br>';
